...
NUM_FRAMES = 10^1; % simulations run (number of frames simulated)
%--------------------------------------------------------------------------
...
R_Input=zeros(Pilot_num,Pilot_num); % autocorrelation matrix.
 ...
 Auto_Cor_Matrix = R_Input + NOISE_VAR_1D/2*eye(Pilot_num);    
%--------------------------------------------------------------------------
% Weight matrix    
Weight_Matrix = Cross_Cor_Matrix/Auto_Cor_Matrix; 
%--------------------------------------------------------------------------
tic()
...
F_SIG_NO_CP(Pilot_Position) = sqrt(2); % all pilot symbols are sqrt(2)
...
Filter_Input = (F_REC_SIG_NO_CP(Pilot_Position))/sqrt(2);
